...
export const mockDistricts: District[] = [
  ...
  { id: 6, name: "Batticaloa", latitude: 7.731, longitude: 81.6747, is_paddy_area: true },
  { id: 7, name: "Puttalam", latitude: 8.0362, longitude: 79.8283, is_paddy_area: true },
  { id: 8, name: "Matara", latitude: 5.9549, longitude: 80.555, is_paddy_area: true },
  { id: 9, name: "Badulla", latitude: 6.9934, longitude: 81.055, is_paddy_area: true },
  { id: 10, name: "Gampaha", latitude: 7.084, longitude: 80.0098, is_paddy_area: true },
]
